...
def main():
    print("--- Comparing 300k vs 500k vs 1000k Side-by-Side ---")
    ...
    test_angles_deg = [0.0, 5.0, 10.0, 12.0, 14.0, 15.0, 16.0, 18.0]
    ...
    for angle_deg in test_angles_deg:
        ...
        # Run until ALL robots have fallen or 5 seconds pass
        while step_count < 250: # 5 seconds
            ...
            # if not done3:
            #     action3, _ = model_1000k.predict(obs3, deterministic=True)
            #     obs3, _, term3, trunc3, _ = env3.step(action3)
            #     done3 = term3 or trunc3
